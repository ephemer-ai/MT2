...
To compensate for these, MT2 scrubs all inputs of anything matching a
...
To test MT2's security using these files, launch the MT2
webserver:
...
Then, with the server running, [launch MT2](http://localhost:5000) and
...
Please contact MT2@cdc.gov with a description of how you got the
