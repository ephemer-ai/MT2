...
This is the odd directory of MT2 dependencies that can't be bundled. for the Javascripts, this is probably because we need accessible to `importScripts` in Workers. For others, it's probably because of some CSS relative path shenanigans.
