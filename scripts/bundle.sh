...
# index.html, html/files.html, or scripts/index.js
primaryscripts=(
...
npx postcss temp.primary.css > css/bundle.primary.css
npx postcss temp.secondary.css > css/bundle.secondary.css
...
rm js/bundle.primary.js && touch js/bundle.primary.js
for i in ${primaryscripts[@]}; do
  cat $i >> js/bundle.primary.js
  printf "\n" >> js/bundle.primary.js
done

rm js/bundle.secondary.js && touch js/bundle.secondary.js
for i in ${secondaryscripts[@]}; do
  cat $i >> js/bundle.secondary.js
  printf "\n" >> js/bundle.secondary.js
done
